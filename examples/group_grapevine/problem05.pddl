...
(define 
    ...
    (:goal (and
        ...
        ; (= (:ontic (= (shared a) 2)) 1)
        ; (= (:epistemic b [b] cb [a,b,c,d] (= (secret a) 'f')) 1)

        ; (= (:epistemic cb [a,c,d] (= (secret a) 't')) 1)


        (= (:epistemic cb [b,c] cb [a,b,c,d] (= (secret a) 'f')) 1)

        (= (:epistemic cb [a,d] (= (secret a) 't')) 1)
